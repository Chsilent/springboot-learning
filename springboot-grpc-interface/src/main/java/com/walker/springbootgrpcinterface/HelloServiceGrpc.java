...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.walker.springbootgrpcinterface.HelloRequest,
      com.walker.springbootgrpcinterface.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.walker.springbootgrpcinterface.HelloRequest.class,
      responseType = com.walker.springbootgrpcinterface.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.walker.springbootgrpcinterface.HelloRequest,
      com.walker.springbootgrpcinterface.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.walker.springbootgrpcinterface.HelloRequest, com.walker.springbootgrpcinterface.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.walker.springbootgrpcinterface.HelloRequest, com.walker.springbootgrpcinterface.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.walker.springbootgrpcinterface.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.walker.springbootgrpcinterface.HelloReply.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.walker.springbootgrpcinterface.HelloRequest request,
        io.grpc.stub.StreamObserver<com.walker.springbootgrpcinterface.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.walker.springbootgrpcinterface.HelloRequest,
                com.walker.springbootgrpcinterface.HelloReply>(
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.walker.springbootgrpcinterface.HelloReply sayHello(com.walker.springbootgrpcinterface.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.walker.springbootgrpcinterface.HelloReply> sayHello(
        com.walker.springbootgrpcinterface.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.walker.springbootgrpcinterface.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.walker.springbootgrpcinterface.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.walker.springbootgrpcinterface.HelloWorldService.getDescriptor();
    }
